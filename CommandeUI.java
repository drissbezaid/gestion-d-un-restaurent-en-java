...
public class CommandeUI extends JFrame {
    ...
    public CommandeUI() {
        ...
        DefaultListModel<String> modelCommande = new DefaultListModel<>();
        ...
        JButton btnAddPlat = RestoUI.actionButton("Ajouter a la commande", new Color(29, 158, 117), Color.WHITE);
        ...
        btnAjouter.addActionListener(e -> {
            String numcStr = JOptionPane.showInputDialog(this, "Numero de commande :");
            if (numcStr != null && !numcStr.trim().isEmpty()) {
                String numtStr = JOptionPane.showInputDialog(this, "Numero de table :");
                if (numtStr != null && !numtStr.trim().isEmpty()) {
                    try {
        ...
        btnAddPlat.addActionListener(e -> {
            ...
            if (plat != null && i != -1) {
                ...
                JOptionPane.showMessageDialog(this, "Selectionnez une commande et un plat !");
            }
        });
